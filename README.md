...
3. Deschide fișierele cu extensia `.js` și rezolvă problemele enunțate în comentariu
4. Fă un commit 
5. Dacă nu reușești să rezolvi complet, poți face commit la ce ai, și vei cere ajutor.
6. Fă push pe GitHub
7. Crează un Pull Request la [proiectul principal](https://github.com/ITSchool-Web-Force/Tema-JS-Clasic/pulls)
